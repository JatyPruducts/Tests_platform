...
export default {
  ...
  data() {
      return {
          ...
          testCompleted: false,
          tests: [
              { title: "Вопрос 1", file: "/tests/final 1/Вопрос 1.txt" },
              { title: "Вопрос 2", file: "/tests/final 1/Вопрос 2.txt" },
              { title: "Вопрос 3", file: "/tests/final 1/Вопрос 3.txt" },
              { title: "Вопрос 4", file: "/tests/final 1/Вопрос 4.txt" },
              { title: "Вопрос 5", file: "/tests/final 1/Вопрос 5.txt" },
              { title: "Вопрос 6", file: "/tests/final 1/Вопрос 6.txt" },
              { title: "Вопрос 7", file: "/tests/final 1/Вопрос 7.txt" },
          ],
          correctAnswers: []
      };
  },
                  ...
                  await axios.post(
                      ...
                      null,
                      {
                          params: {
                              ...
                              test_name: "Итоговый тест по теме 1",
                              result_data: result
                          }
                      }
                  );
